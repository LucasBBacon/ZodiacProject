...
public class CameraControlTrigger : MonoBehaviour
{
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            if (
                customInspectorObjects.swapCameras &&
            ...
            if (
                customInspectorObjects.panCameraOnContact
                )
            {
                CameraManager.instance.PanCameraOnContact
                    (
...
public class MyScriptEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (
            cameraControlTrigger.customInspectorObjects.swapCameras
            )
        {
        ...
        if (
            cameraControlTrigger.customInspectorObjects.panCameraOnContact
            )
        {
